...
namespace RockPaperScissors
{
  public class GameTest
  {
    ...
    //
    // [Fact]
    // public void GameTest9()
    // {
    //   Game testGame = new Game("rock", "scissors");
    //   Assert.Equal("Rock crushes scissors. Player 1 Wins!", testGame.TestFunction());
    // }
    // [Fact]
    // public void TestOriginalFunction()
    // {
    //   Game testGame = new Game("rock", "scissors");
    //   Assert.Equal("Rock crushes scissors. Player 1 Wins!", testGame.DetermineWinner());
    // }
    [Fact]
    public void TestNewFunction()
    {
      Game testGame = new Game("paper", "scissors");
      Assert.Equal(testGame.DetermineWinner(), testGame.TestFunction());
    }
  }
}
